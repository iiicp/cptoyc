...
void PrintPPOutputPPCallbacks::WriteLineInfo(unsigned LineNo,
    ...
    if (FileType == C_System)
        OS.write(" 3", 2);
    else if (FileType == C_ExternCSystem)
        OS.write(" 3 4", 4);
    OS << '\n';
}
...
void PrintPPOutputPPCallbacks::FileChanged(SourceLocation Loc,
                                           ...
                                           CharacteristicKind NewFileType) {
...
void CPToyC::Compiler::DoPrintMacros(Preprocessor &PP, llvm::raw_ostream *OS) {
...
///
void CPToyC::Compiler::DoPrintPreprocessedInput(Preprocessor &PP, llvm::raw_ostream *OS,
