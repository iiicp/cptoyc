...
namespace CPToyC {
    namespace Compiler {
        ...
        public:
            ...
            /// 'dir'.
            DirectoryLookup(const DirectoryEntry *dir, CharacteristicKind DT,
            ...
            /// DirectoryLookup ctor - Note that this ctor *does not take ownership* of
            /// 'map'.
            DirectoryLookup(const HeaderMap *map, CharacteristicKind DT,
                            bool isUser)
            ...
            /// values.
            CharacteristicKind getDirCharacteristic() const {
                return (CharacteristicKind) DirCharacteristic;
            }
...
#endif//CPTOYC_DIRECTORYLOOKUP_H
