...
#ifndef CPTOYC_SOURCEMANAGER_H
#define CPTOYC_SOURCEMANAGER_H
...
namespace CPToyC {
    namespace Compiler {
        ...
        class ContentCache {
            ...
            mutable const MemoryBuffer *Buffer;
        ...
        public:
            ...
            void setBuffer(const MemoryBuffer *B) {
        ...
        public:
            ...
            void AddLineNote(unsigned FID, unsigned Offset,
                             unsigned LineNo, int FilenameID,
                             unsigned EntryExit, CharacteristicKind FileKind);
        ...
        class SourceManager {
            ...
            std::vector<SLocEntry> SLocEntryTable;
            ...
            mutable ContentCache *LastLineNoContentCache;
        ...
        public:
            ...
            FileID createMainFileID(const FileEntry *SourceFile,
                ...
                MainFileID = createFileID(SourceFile, IncludePos, C_User);
                return MainFileID;
            }
            ...
            FileID createFileIDForMemBuffer(const MemoryBuffer *Buffer,
                                            unsigned PreallocatedID = 0,
                                            unsigned Offset = 0) {
                return createFileID(createMemBufferContentCache(Buffer), SourceLocation(),
                                    C_User, PreallocatedID, Offset);
            }
            ...
            FileID createMainFileIDForMemBuffer(const MemoryBuffer *Buffer) {
                assert(MainFileID.isInvalid() && "MainFileID already set!");
            ...
            ///
            const MemoryBuffer *getBuffer(FileID FID) const {
            ...
            getDecomposedInstantiationLoc(SourceLocation Loc) const {
                FileID FID = getFileID(Loc);
                const SLocEntry *E = &getSLocEntry(FID);
            ...
            CharacteristicKind getFileCharacteristic(SourceLocation Loc) const;
            ...
            bool isInSystemHeader(SourceLocation Loc) const {
                return getFileCharacteristic(Loc) != C_User;
            }

            /// isInExternCSystemHeader - Returns if a SourceLocation is in an "extern C"
            /// system header.
            bool isInExternCSystemHeader(SourceLocation Loc) const {
                return getFileCharacteristic(Loc) == C_ExternCSystem;
            }
            ...
            typedef std::vector<SLocEntry>::const_iterator sloc_entry_iterator;
            ...
            const SLocEntry &getSLocEntry(FileID FID) const {
        ...
        private:
            ...
            FileID createFileID(const ContentCache* File,
                                SourceLocation IncludePos,
                                CharacteristicKind DirCharacter,
                                unsigned PreallocatedID = 0,
                                unsigned Offset = 0);
            ...
            ///  memory buffer.
            const ContentCache*
            createMemBufferContentCache(const MemoryBuffer *Buf);
            ...
            std::pair<FileID, unsigned>
            getDecomposedInstantiationLocSlowCase(const SLocEntry *E,
                                                  unsigned Offset) const;
            std::pair<FileID, unsigned>
            getDecomposedSpellingLocSlowCase(const SLocEntry *E,
                                             unsigned Offset) const;
        };
    }
}
