...
namespace CPToyC {
	namespace Compiler {
        ...
        class Lexer : public PreprocessorLexer{
            ...
            Lexer(const Lexer&) = delete;          // DO NOT IMPLEMENT
            void operator=(const Lexer&) = delete; // DO NOT IMPLEMENT
        ...
        public:
            ...
            Lexer(SourceLocation FileLoc, const char *BufStart,
                  const char *BufPtr, const char *BufEnd);

            /// Lexer constructor - Create a new raw lexer object.  This object is only
            /// suitable for calls to 'LexRawToken'.  This lexer assumes that the text
            /// range will outlive it, so it doesn't take ownership of it.
            Lexer(FileID FID, const SourceManager &SM);
