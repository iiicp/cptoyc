...
void Preprocessor::EnterSourceFileWithLexer(Lexer *TheLexer, const DirectoryLookup *CurDir) {
...
//        }
    ...
    if (CurLexer) {
        ...
        assert(false && "Got EOF but no current lexer set!");
